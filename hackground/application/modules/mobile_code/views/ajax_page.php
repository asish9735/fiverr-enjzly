		...
		<form role="form" id="add_form" action="<?php echo $form_action;?>" onsubmit="submitForm(this, event)">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <input type="text" class="form-control reset_field" id="codes" name="codes" autocomplete="off" />
                </div>
...
<div class="modal-body">
		<form role="form" id="add_form" action="<?php echo $form_action;?>" onsubmit="submitForm(this, event)">
              ...
              <div class="box-body">
				...
				<div class="form-group">
                  <label for="codes">Code </label>
                  <input type="text" class="form-control reset_field" id="codes" name="codes" autocomplete="off" value="<?php echo !empty($detail['codes']) ? $detail['codes'] : ''; ?>"/>
                </div>
