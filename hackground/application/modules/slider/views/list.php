              ...
              <table class="table table-hover">
				...
				<tr>
                  ...
                  <!--<td><?php echo $v['name']; ?></td>-->
                   <td>
                  	<?php if(!empty($v['slide_image']) && file_exists(LC_PATH.'userupload/slider-user/'.$v['slide_image'])){ ?>
                  	<img src="<?php echo USER_UPLOAD.'slider-user/'.$v['slide_image']; ?>" class="img-rounded" alt="" width="210">
                  	<?php }?>
                  </td>
