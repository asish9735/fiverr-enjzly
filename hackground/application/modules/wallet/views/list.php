		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				<tr>
                  ...
                  <th style="width:20%" class="text-center">Withdraw (<?php echo get_setting('site_currency');?>)</th>
				...
				<tr>
                  ...
                  <td class="text-center text-red"><?php echo format_money($v['withdrawn']); ?></td>
                  <td class="text-center text-green"><?php echo format_money($v['balance']); ?></td>
                 
                  <td class="text-right" style="padding-right:20px;">
					<a href="<?php echo base_url('wallet/txn_detail/'.$v['wallet_id']); ?>" data-toggle="tooltip" title="View Transaction"><i class="fa fa-th-list green <?php echo ICON_SIZE;?>"></i></a>
				  </td>
                </tr>
				<?php } }else{  ?>
				<tr>
