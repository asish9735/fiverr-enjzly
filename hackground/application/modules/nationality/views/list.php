      ...
      <div class="box">
		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				$status = '';
				if($v['nationality_status'] == ACTIVE_STATUS){
				...
				}else if($v['nationality_status'] == INACTIVE_STATUS){
				...
				<tr>
                  ...
                  <td><?php echo $v['nationality_name']; ?></td>
                  <td><?php echo $status; ?></td>
                  <td class="text-right" style="padding-right:20px;">
					<?php if($v['nationality_status'] != DELETE_STATUS){ ?>
