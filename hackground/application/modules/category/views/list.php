              ...
              <table class="table table-hover">
				...
				<tr>
                  ...
                  <td class="text-right" style="padding-right:20px;">
					...
					<a href="<?php echo JS_VOID; ?>" onclick="add_sub_category('<?php echo $v[$primary_key]; ?>')" data-toggle="tooltip" title="Add Sub Category"><i class="fa fa-plus <?php echo ICON_SIZE;?>"></i></a>
					&nbsp;
