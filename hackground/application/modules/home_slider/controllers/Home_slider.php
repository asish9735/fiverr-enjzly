   ...
   private $data;
	...
	public function add(){
		...
		if(post() && $this->input->is_ajax_request()){
			...
			$this->form_validation->set_rules('slide_image', 'slide_image', 'required');
	...
	public function upload_file(){
		if($_FILES && $this->input->is_ajax_request()){
			$upload_dir = LC_PATH.'userupload/slider/';
			...
			if(! $this->upload->do_upload('file')){
				...
				$this->api->data('file_url', USER_UPLOAD.'slider/'.$this->upload->data('file_name'));
			}
