	...
	public function change_status(){
		if(post() && $this->input->is_ajax_request()){
			...
			if($action_type == 'multiple'){
				...
				$html = '';
				if($sts == '1'){
					$html = '<span class="label label-success">Read</span>';
				}else{
					$html = '<a href="'.JS_VOID.'"  data-toggle="tooltip" title="Mark as read" onclick="changeStatus(1, '.$ID.',this)"><span class="label label-default">Unread</span></a>';
				}
