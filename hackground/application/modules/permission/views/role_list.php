		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				if($v['status'] == ACTIVE_STATUS){
					$status = '<a href="'.JS_VOID.'"  data-toggle="tooltip" title="Make inactive" onclick="changeStatus(0, '.$v['role_id'].',this)"><span class="label label-success">Active</span></a>';
				}else if($v['status'] == INACTIVE_STATUS){
					$status = '<a href="'.JS_VOID.'" data-toggle="tooltip" title="Make active"  onclick="changeStatus(1, '.$v['role_id'].', this)"><span class="label label-danger">Inactive</span></a>';
				}else{
					$status = '<a href="'.JS_VOID.'" data-toggle="tooltip" title="Restore"  onclick="changeStatus(1, '.$v['role_id'].', this)"><span class="label label-danger">Deleted</span></a>';
				}
				...
				<tr>
                  ...
                  <td class="text-right" style="padding-right:20px;">
					...
					&nbsp;
					<a href="<?php echo JS_VOID; ?>" onclick="edit('<?php echo $v['role_id']; ?>')" data-toggle="tooltip" title="Edit"><i class="fa fa-edit green <?php echo ICON_SIZE;?>"></i></a>
					&nbsp;
					<a href="<?php echo JS_VOID; ?>" onclick="return deleteRecord('<?php echo $v['role_id']; ?>')"data-toggle="tooltip" title="Delete"><i class="fa fa-trash red <?php echo ICON_SIZE;?>"></i></a>
					<?php }elseif(ALLOW_PERMANENT_DELETE){ ?>
					<a href="<?php echo JS_VOID; ?>" onclick="return deleteRecord('<?php echo $v['role_id']; ?>', true)"data-toggle="tooltip" title="Delete Permanently"><i class="fa fa-trash red <?php echo ICON_SIZE;?>"></i></a>
					<?php } ?>
