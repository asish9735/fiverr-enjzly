...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url()?>" class="logo">
      ...
      <span class="logo-mini"><?php echo get_setting('admin_short_code');?></span>

      <!-- logo for regular state and mobile devices -->

      <span class="logo-lg"><img src="<?php echo ADMIN_IMAGES;?>logo.png" alt="" title="<?php echo get_setting('site_title');?>" height="48" /></span>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-left">
                  ...
                  <a href="javascript:void(0)" class="btn btn-outline-success" onclick="edit_profile()">Profile</a>

                </div>

                <div class="pull-right">

                  <a href="<?php echo base_url('login/logout')?>" class="btn btn-outline-success">Sign out</a>
