				...
				<div class="dashboard-nav">
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Account">
							<li><a href="<?php D(get_link('settingaccountInfoURL'))?>"><i class="icon-material-outline-settings"></i> Settings</a>
								<ul>
									<li><a href="<?php D(get_link('settingaccountInfoURL'))?>">Contact info</a></li>
									<li><a href="<?php D(get_link('settingpasswordURL'))?>">Password & security</a></li>
									<li><a href="<?php D(get_link('myprofileAJAXURL'))?>">My profile</a></li>
								</ul>
