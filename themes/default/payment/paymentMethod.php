...
<button class="btn btn-site btn-block saveBTN" type="submit" name="checkout_submit_order" onclick="return confirm('Are you sure you want to pay for this with your shopping balance?')">
...
<form action="" class="checkoutForm" method="post" id="paypal-form" onsubmit="return processCheckout(this);return false;">
	...
	<input type="hidden" name="payfor" value="<?php D($payfor)?>">
	<button type="submit" name="paypal" class="btn btn-site btn-block saveBTN"><?php D(__('paymentmethod_page_Pay_With_Paypal',"Pay With Paypal"));?> </button>
</form>
<?php } ?>
...
<form action="" class="checkoutForm" method="post" id="telr-form" onsubmit="return processCheckout(this);return false;">
	...
	<input type="hidden" name="payfor" value="<?php D($payfor)?>">
	<button type="submit" name="telr" class="btn btn-site btn-block saveBTN"><?php D(__('paymentmethod_page_Pay_With_Telr',"Pay With Telr"));?></button>
</form>
<?php } ?>
...
<form action="" class="checkoutForm" method="post" id="ngenius-form" onsubmit="return processCheckout(this);return false;">
	...
	<input type="hidden" name="payfor" value="<?php D($payfor)?>">
	<button type="submit" name="ngenius" class="btn btn-site btn-block saveBTN"><?php D(__('paymentmethod_page_Pay_With_Ngenius',"Pay With Ngenius"));?></button>
</form>
<?php } ?>
...
<form action="" class="checkoutForm" method="post" id="bank-form" onsubmit="return processCheckout(this);return false;">
	...
	<input type="hidden" name="payfor" value="<?php D($payfor)?>">
	<button type="submit" name="bank" class="btn btn-site btn-block saveBTN"><?php D(__('paymentmethod_page_Pay_With_Bank',"Pay With Bank Transfer"));?></button>
</form>
<?php } ?>
...
<form action="" class="checkoutForm" method="post" id="credit-card-form" onsubmit="return processCheckout(this);return false;">
	...
	<input type="hidden" name="payfor" value="<?php D($payfor)?>">
	<button type="submit" name="stripe" class="btn btn-site btn-block saveBTN"><?php D(__('paymentmethod_page_Pay_With_Credit_Card',"Pay With Credit Card"));?> </button>
</form>
<?php } ?>
...
<form action="" class="checkoutForm" method="post" id="payza-form" onsubmit="return processCheckout(this);return false;">
	...
	<input type="hidden" name="payfor" value="<?php D($payfor)?>">
	<button type="submit" name="payza" class="btn btn-site btn-block saveBTN"><?php D(__('paymentmethod_page_Pay_With_Payza',"Pay With Payza"));?></button>
</form>
<?php } ?>
...
<form action="" class="checkoutForm" method="post" id="coinpayments-form" onsubmit="return processCheckout(this);return false;">
	...
	<input type="hidden" name="payfor" value="<?php D($payfor)?>">
	<button type="submit" name="coinpayments" class="btn btn-site btn-block saveBTN"><?php D(__('paymentmethod_page_Pay_With_Coinpayments',"Pay With Coinpayments"));?></button>
</form>
<?php } ?>
...
<form action="" class="checkoutForm" method="post" id="mobile-money-form" onsubmit="return processCheckout(this);return false;">
	...
	<input type="hidden" name="payfor" value="<?php D($payfor)?>">
	<button type="submit" name="coinpayments" class="btn btn-site btn-block saveBTN"><?php D(__('paymentmethod_page_Pay_With_Mobile_Money',"Pay With Mobile Money"));?></button>
</form>
<?php } ?>
<?php }else{?>
	<div class="alert alert-warning clearfix activate-email-class">
	<?php D(__('global_verify_email_reminder_message','Please verify your account first.'));?>
	</div>	
<?php }?>
