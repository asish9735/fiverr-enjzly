    ...
    <div class="card-body">
    	<div class="d-flex align-items-center mb-3">
            <span class="fit-avatar mr-3">        	
                ...
                <img src="<?php D(getMemberLogo($proposal->proposal_seller_id))?>" alt="" height="44" width="44" /></a>
		...
		<p class="proposal-link-main"><a href="<?php D($url); ?>" class="js-proposal-card-imp-data"> <?php D($proposal->proposal_title); ?></a></p>
