...
?>
                ...
                <div class="job-listing-details">
                	<!-- Logo -->
						<div class="job-listing-company-logo">
							<img src="<?php D(getMemberLogo($conversation->sender_id)); ?>" alt="">
						</div>
                    ...
                    <div class="job-listing-description">
                        ...
                        <div class="job-listing-footer">
                            <ul>
                                <li><small><i class="icon-material-outline-date-range"></i>
	...
	<div class="<?php D(($conversation->sender_id==$loggedUser['MID']? 'message-div-hover':' message-div'))?>">
...
?>
	...
	<div class="card mt-4">
	   <div class="card-body">
	   	<h5 class="text-center">
	   		<i class="fa fa-pencil-square-o"></i> <?php D(__('order_conversation_page_Revison_Requested_By',"Revison Requested By"));?> <?php /*D($conversation->member_name);*/ D($sender_user_name); ?> 
	   	</h5>
	   </div>
	</div>
	<div class="<?php D(($conversation->sender_id==$loggedUser['MID']? 'message-div-hover':' message-div'))?>"><!--- message-div Starts --->
	...
	<div class="card mt-4">
	   <div class="card-body">
	   	<h5 class="text-center">
	   		<i class="fa fa-trash-o"></i> <?php D(__('order_conversation_page_Cancellation_Requested_By',"Cancellation Requested By"));?> <?php /*D($conversation->member_name);*/ D($sender_user_name); ?> 
	   	</h5>
	   </div>
	</div>
	<div class="<?php D(($conversation->sender_id==$loggedUser['MID']? 'message-div-hover':' message-div'))?>"><!--- message-div Starts --->
		...
		<form class="mb-2"  method="post" id="reportrequestForm" >
			<center>
				...
				<button name="decline_request" id="decline_request" type="button" class="btn btn-success btn-sm" onclick="return performAction(this);return false;"><?php D(__('order_conversation_page_Decline_Request',"Decline Request"));?></button>
		   </center>
		</form>
		<?php }?>
		<p class="text-right text-muted mb-0" style="font-size: 14px;"> 
