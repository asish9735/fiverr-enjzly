        ...
        <div class="tab-content">
                ...
                <li>
                  <div class="job-listing">
                    <div class="job-listing-details">
                      <div class="job-listing-user-logo"> <a href="<?php D(get_link('viewprofileURL').$username) ; ?>" target="blank"><img src="<?php D(getMemberLogo($buyer->member_id))?>" alt="" class="rounded-circle"></a> </div>
                      <div class="job-listing-description">
                        <h4 class="job-listing-title"><a href="<?php D(get_link('viewprofileURL').$username) ; ?>" target="blank">
                          <?php /*D($buyer->member_name)*/ D($username);?>
                          </a></h4>
                        <div class="job-listing-footer mb-2">
                          <ul>
                            <li><i class="icon-feather-calendar"></i><b>
                              <?php D(__('contacts_page_Completed_Orders',"Completed Orders"));?>
                              :</b>
                              <?php D($buyer->total_order)?>
                            </li>
                            <li><i class="icon-feather-calendar"></i><b>
                              <?php D(__('contacts_page_Amount_Spent',"Amount Spent"));?>
                              :</b>
                              <?php D($s_currency); ?>
                              <?php D($buyer->total_amount)?>
                            </li>
                            <li><i class="icon-feather-calendar"></i><b>
                              <?php D(__('contacts_page_Last_Order_Date',"Last Order Date"));?>
                              :</b>
                              <?php D(dateFormat($buyer->last_order_date,'F d, Y'));?>
                            </li>
                          </ul>
                        </div>
                        <a href="<?php D(get_link('viewprofileURL').$username) ; ?>" target="blank" class="btn btn-sm btn-outline-site mr-2">
						<?php D(__('contacts_page_User_Profile',"User Profile"));?>
                        </a> <a href="<?php D(get_link('BuyingHistoryURL').$buyer->member_id) ; ?>" class="btn btn-sm btn-outline-dark">
                  ...
                  <div class="buttons-to-right single-right-button always-visible">
                   <a href="<?php D(get_link('messageLink').'/'.$buyer->member_id) ; ?>" target="blank" class="btn btn-sm btn-site"> <i class="icon-feather-message-square"></i> </a> </div>
                </li>
                <?php }
			...
			?>
                <li>
                  <div class="alert alert-danger mb-0 w-100">
                    <?php D(__('contacts_page_no_buyer',"You currently have no buyers in your contact book"));?>
                  </div>
                  <?php }?>
              </ul>
            </div>
          ...
          <div id="my_sellers" class="tab-pane fade <?php if($tab=='seller'){ D("show active");}?>">
            <div class="dashboard-box mt-0">
              ...
              <ul class="dashboard-box-list">
                ...
                <li>
                  <div class="job-listing">
                    <div class="job-listing-details">
                      <div class="job-listing-user-logo"> <a href="<?php D(get_link('viewprofileURL').$username) ; ?>" target="blank"><img src="<?php D(getMemberLogo($seller->member_id))?>" alt="" class="rounded-circle"></a> </div>
                      <div class="job-listing-description">
                        <h4 class="job-listing-title"><a href="<?php D(get_link('viewprofileURL').$username) ; ?>" target="blank">
                          <?php /*D($buyer->member_name)*/ D($username);?>
                          </a></h4>
                        <div class="job-listing-footer mb-2">
                          <ul>
                            <li><i class="icon-feather-calendar"></i><b>
                              <?php D(__('contacts_page_Completed_Orders',"Completed Orders"));?>
                              :</b>
                              <?php D($seller->total_order)?>
                            </li>
                            <li><i class="icon-feather-calendar"></i><b>
                              <?php D(__('contacts_page_Amount_Spent',"Amount Spent"));?>
                              :</b>
                              <?php D($s_currency); ?>
                              <?php D($seller->total_amount)?>
                            </li>
                            <li><i class="icon-feather-calendar"></i><b>
                              <?php D(__('contacts_page_Last_Order_Date',"Last Order Date"));?>
                              :</b>
                              <?php D(dateFormat($seller->last_order_date,'F d, Y'));?>
                            </li>
                          </ul>
                        </div>
                        <a href="<?php D(get_link('viewprofileURL').$username) ; ?>" target="blank" class="btn btn-sm btn-outline-site mr-2">
                  ...
                  <div class="buttons-to-right single-right-button always-visible">
                   <a href="<?php D(get_link('messageLink').'/'.$seller->member_id) ; ?>" target="blank" class="btn btn-sm btn-site"> <i class="icon-feather-message-square"></i> </a> </div>
                </li>
                <?php }
			...
			?>
                <li>
                  <div class="alert alert-danger mb-0 w-100">
                    <?php D(__('contacts_page_no_freelancer',"You currently have no freelancer in your contact book"));?>
                  </div>
                </li>
                <?php
