...
<div class="container-fluid mt-5">
	...
	<div class="col-xl-3 col-lg-4 col-12">
      ...
      <div class="col-xl-9 col-lg-8 col-12">
	    <h3><?php D(__('selling_history_page_Purchases_From',"Purchases From"));?> <a href="<?php D(get_link('viewprofileURL').$seller_user_name); ?>"><?php /*D(ucfirst($member_details['member']->member_name));*/ D($seller_user_name); ?></a> </h3>
		<h6><?php D(count($all_orders)); ?> <?php D(__('selling_history_page_Results_Found',"Results Found"));?></h6>
			<div class="table-responsive bg-white mt-3">
				<?php if($all_orders){
					...
					<table class="table table-bordered mb-0">
						<thead>
							<tr> 
								<th><?php D(__('selling_history_page_ORDER_SUMMARY',"ORDER SUMMARY"));?></th>
								<th><?php D(__('selling_history_page_ORDER_DATE',"ORDER DATE"));?></th>
								<th><?php D(__('selling_history_page_DUE_ON',"DUE ON"));?></th>
								<th><?php D(__('selling_history_page_TOTAL',"TOTAL"));?></th>
								<th><?php D(__('selling_history_page_STATUS',"STATUS"));?></th>
							</tr>
						</thead>
						<tbody>
					<?php
				...
				?>
						<tr>
							...
							<td>
								<button class="btn btn-sm btn-success"><?php D(ucwords($orderStatus[$order->order_status])); ?></button>
							</td>
						</tr>
				<?php		
				}
			...
			<center>
				<h3 class='pb-4 pt-4'><i class='fa fa-meh-o'></i> <?php D(__('selling_history_page_no_sold',"No proposals/services sold at the momment."));?></h3>
			</center>
			<?php }?>
			</div>
