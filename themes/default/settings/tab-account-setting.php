...
<div class="card mb-4">
	...
	<div class="card-header"><h5><?php D(__('account_settings_page_paypal_heading',"PayPal For Withdrawing Revenue"));?>  </h5></div>

	<div class="card-body">

    <form action="" method="post" accept-charset="utf-8" id="accountPaypalform" class="form-horizontal" role="form" name="accountPaypalform" onsubmit="saveAccount(this);return false;">

    <input type="hidden" name="section" value="paypal"/>

        <div class="form-group row">

            <label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_paypal_Enter_Email',"Enter Paypal Email"));?> </label>
...
<div class="card mb-4">
	...
	<div class="card-header"><h5> <?php D(__('account_settings_page_bank_heading',"Bank Transfer For Withdrawing Revenue"));?>  </h5></div>

    <div class="card-body">

<form action="" method="post" accept-charset="utf-8" id="accountBankform" class="form-horizontal" role="form" name="accountBankform" onsubmit="saveAccount(this);return false;">
...
<input type="hidden" name="section" value="bank"/>
	...
	<div class="form-group row">
		...
		<label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_Bank_Name',"Bank Name"));?> </label>
	...
	<div class="form-group row">
		...
		<label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_Bank_Swift_Code',"Swift Code"));?> </label>
	...
	<div class="form-group row">
		...
		<label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_Bank_IBAN',"IBAN"));?> </label>
...
<div class="card mb-4">
	...
	<div class="card-header">
    	...
    	<h5> <?php D(__('account_settings_page_Payoneer_heading',"Payoneer For Withdrawing Revenue"));?>  </h5>

    </div>

<div class="card-body">

<form action="" method="post" accept-charset="utf-8" id="accountPayoneerform" class="form-horizontal" role="form" name="accountPayoneerform" onsubmit="saveAccount(this);return false;">

<input type="hidden" name="section" value="payoneer"/>

	<div class="form-group row">

		<label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_Payoneer_Email',"Enter Email"));?> </label>
...
<h5 class="mb-4"> <?php D(__('account_settings_page_Mobile_Money_heading',"Mobile Money For Withdrawing Revenue"));?>  </h5>
...
<input type="hidden" name="section" value="m_money"/>
	...
	<div class="form-group row">
		...
		<label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_Mobile_Money_Account_Number',"Account Number"));?> </label>
		...
		<div class="col-md-9">
			...
			<span id="m_account_numberError" class="rerror"></span>
	...
	<div class="form-group row">
		...
		<label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_Mobile_Money_Account_Owner',"Account/Owner Name"));?> </label>
		...
		<div class="col-md-9">
			...
			<span id="m_account_nameError" class="rerror"></span>
...
<h5 class="mb-4"> <?php D(__('account_settings_page_Bitcoin_heading',"Bitcoin Wallet For Withdrawing Revenue"));?> </h5>
...
<input type="hidden" name="section" value="bitcoin"/>
  ...
  <div class="form-group row">
    ...
    <label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_Bitcoin_Address',"Wallet Address"));?> </label>
    ...
    <div class="col-md-9">
      ...
      <span id="bitcoin_seller_walletError" class="rerror"></span>

      <small class="text-danger"><?php D(__('account_settings_page_Bitcoin_Address_note',"! Warning You Only Need To Enter Your Bitcoin Wallet Address Not Any Other."));?></small>
  ...
  <div class="row">
	...
	<div class="col-md-9 offset-md-3">
  		...
  		<button type="submit" name="submit_wallet" class="btn btn-site saveBTN"><?php D(__('account_settings_page_Bitcoin_button',"Update Wallet Address"));?></button>
...
<form method="post" class="clearfix">
  ...
  <div class="form-group row mb-3">
    ...
    <label class="col-md-3 col-form-label"> Enable/disable sound </label>
...
<div class="card mb-4">
	...
	<div class="card-header"><h5> <?php D(__('account_settings_page_Change_Password_heading',"Change Password"));?> </h5></div>
...
<form action="" method="post" accept-charset="utf-8" id="accountPasswordform" class="form-horizontal" role="form" name="accountPasswordform" onsubmit="saveAccount(this);return false;">
	...
	<div class="form-group row">
		...
		<label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_Change_Password_Old_Password',"Enter Old Password"));?> </label>
	...
	<div class="form-group row">
		...
		<label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_Change_Password_New_Password',"Enter New Password"));?> </label>
	...
	<div class="form-group row">
		...
		<label class="col-md-3 col-form-label"> <?php D(__('account_settings_page_Change_Password_Confirm_Password',"Confirm New Password"));?> </label>
...
<div class="card-header"><h5> <?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_heading',"Account Deactivation"));?> </h5></div>

<div class="card-body">

<div class="row">

<label class="col-md-3 col-form-label"><?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_text',"What happens when you deactivate your account?"));?></label>

<div class="col-md-9">

<ul class="list-unstyled mb-4">	

	<li><i class="fa fa-hand-o-right"></i> <?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_info_1',"Your profile and services won't be shown on ".$get_site_name." anymore."));?> </li>

	<li><i class="fa fa-hand-o-right"></i> <?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_info_2',"Any open orders will be cancelled and refunded."));?> </li>

	<li><i class="fa fa-hand-o-right"></i> <?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_info_3',"You won\'t be able to re-activate your proposals/services."));?> </li>

	<li><i class="fa fa-hand-o-right"></i> <?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_info_4',"You won\'t be able to restore your account."));?> </li>
    ...
    <div class="form-group"><!-- form-group Starts -->
        ...
        <h5 class="pt-3 pb-3">  <?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_withdraw',"Please withdraw your revenues before deactivating your account."));?> </h5>

    </div><!-- form-group Ends -->

    <button type="submit" name="deactivate_account" disabled class="btn btn-danger float-right">

        <i class="fa fa-frown-o"></i> <?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_button',"Deactivate Account"));?>
...
<form action="" method="post" accept-charset="utf-8" id="accountDeactivateform" class="form-horizontal" role="form" name="accountDeactivateform" onsubmit="saveAccount(this);return false;">
	...
	<label class="col-md-3 col-form-label"><?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason',"Why Are You Leaving?"));?> </label>    

    <div class="col-md-9">

	<select name="deactivate_reason" id="deactivate_reason" class="form-control">

		<option class="hidden"> <?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason_select',"Choose A Reason"));?> </option>

		<option> <?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason_option_1',"The quality of service was less than expected"));?> </option>

		<option><?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason_option_2',"I just don\'t have the time"));?></option>

		<option><?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason_option_3',"I can’t find what I am looking for"));?></option>

		<option><?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason_option_4',"I had a bad experience with a seller / buyer"));?></option>

		<option><?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason_option_5',"I found the site difficult to use"));?></option>

		<option><?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason_option_6',"The level of customer service was less than expected"));?></option>

		<option><?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason_option_7',"I have another ".$get_site_name." account"));?></option>

		<option><?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason_option_8',"I\'m not receiving enough orders"));?></option>

		<option><?php D(__('account_settings_page_ACCOUNT_DEACTIVATION_reason_option_9',"Other"));?></option>
